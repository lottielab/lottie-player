// Exports that should work from all entrypoints - @lottielab/lottie-player,
// @lottielab/lottie-player/react, and @lottielab/lottie-player/web.
...
export { EasingPresets } from './common/interactivity';
